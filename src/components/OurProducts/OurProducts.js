...
//         <h2 className="products-title">Studio Cabinets Colors in Stock</h2>
//         <motion.div 
...
//             >
//               <div className="product-image" style={{ backgroundImage: `url(${color.image})`, backgroundSize: 'cover', backgroundPosition: 'left center' }}>
//                 <motion.div 
