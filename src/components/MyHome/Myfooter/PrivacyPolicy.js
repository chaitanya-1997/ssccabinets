  ...
  return (
            ...
            <Card className="text-start">
              <h2 className="text-center mb-4 card-title">
                ...
                Studio Signature Cabinets Privacy Policy
              </h2>
              <p className='prv'>
                This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from <a href="https://studiosignaturecabinets.com" target="_blank" rel="noopener noreferrer">https://studiosignaturecabinets.com</a> (the “Site”).
              </p>
              ...
              <p className='prv'>We collect Device Information using the following technologies:</p>
              <ul>
                <li>
              ...
              <p className='prv'>You can opt out of targeted advertising by:</p>
              <ul>
              ...
              <h3>Contact Us</h3>
              <p className='prv'>
                For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at <a href="mailto:info@studiosignaturecabinets.com">info@studiosignaturecabinets.com</a> or by mail using the details provided below:
              </p>
              <p className='prv'>
