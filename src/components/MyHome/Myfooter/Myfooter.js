          ...
          <div className="footer-content">
            ...
            <div className="footer-logo">
              ...
              <div className="social-icons">
                <a href="facebook.com" className="social-icon"><FaFacebookF /></a>
                <a href="instagram.com" className="social-icon"><FaInstagram /></a>
                <a href="linkdin.com" className="social-icon"><FaLinkedinIn /></a>
                <a href="google.com" className="social-icon"><FaPinterestP /></a>
              </div>
            </div>
